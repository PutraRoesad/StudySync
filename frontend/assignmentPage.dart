...
Future<void> main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlwcHJwc3pvZ29tcm1weGdvZ3Z5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM0NzQ3NjcsImV4cCI6MjA1OTA1MDc2N30.4u1kMqYCPOsJ2-iy1wNOKyYoB3lAlRG7itmoL6TQCOM",
  );
            ...
            child: _isLoading
                ...
                : _errorMessage.isNotEmpty
                    ...
                    : _assignments.isEmpty
                        ? const Center(child: Text('No assignments found. Add a new task!'))
                        : ListView.builder(
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                Column(
                  children: [
                    Image(image: AssetImage('assets/image/home.png'), width: 48, height: 48),
                    Text('Home',
                    style: TextStyle(
                      fontFamily: 'custom',
                      fontSize: 16,
                ...
                Column(
                  children: [
                    Image(image: AssetImage('assets/image/settings.png'), width: 48, height: 48),
                    Text('Settings',
                    style: TextStyle(
                      fontFamily: 'custom',
                      fontSize: 16,
                ...
                Column(
                  children: [
                    Image(image: AssetImage('assets/image/account_circle.png'), width: 48, height: 48),
                    Text('Profile',
                    style: TextStyle(
                      fontFamily: 'custom',
                      fontSize: 16,
